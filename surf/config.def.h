...
#define COPY_URL "xprop -id $1 _SURF_URI | cut -d '\"' -f 2 | xclip	\
-selection clipboard"
...
static Key keys[] = {
	...
	{ MODKEY,                GDK_KEY_eacute,      spawn,      SETPROP("_SURF_FIND", "_SURF_FIND", PROMPT_FIND) },
	...
	{ MODKEY|GDK_SHIFT_MASK, GDK_KEY_r,      find,       { .i = -1 } },
